...
export async function testApiConnection(): Promise<FullTestReport> {
  ...
  // Test endpoints
  const endpoints = [
    { path: '/health', method: 'GET' as const, requiresAuth: false },
    { path: '/auth/me', method: 'GET' as const, requiresAuth: true },
    ...
    { path: '/videos', method: 'GET' as const, requiresAuth: true },
    { path: '/labels', method: 'GET' as const, requiresAuth: true },
    { path: '/publishers', method: 'GET' as const, requiresAuth: true },
    { path: '/writers', method: 'GET' as const, requiresAuth: true },
    { path: '/producers', method: 'GET' as const, requiresAuth: true },
    { path: '/performers', method: 'GET' as const, requiresAuth: true },
    { path: '/royalties', method: 'GET' as const, requiresAuth: true },
    { path: '/payouts', method: 'GET' as const, requiresAuth: true },
    { path: '/dashboard', method: 'GET' as const, requiresAuth: true },
  ];
  ...
  logger.info(`Total: ${summary.total} | Passed: ${summary.passed} | Failed: ${summary.failed}`);
...
export function validateApiConfig(): {
  ...
  if (isLiveMode()) {
    ...
    if (!API_CONFIG.API_KEY) {
      warnings.push('API key is not configured (VITE_API_KEY)');
    }
